...
protocol AnnotationViewDelegate {
    func didTouch(annotationView: StoryAnnotationView)
}


class StoryAnnotationView: ARAnnotationView {
    ...
    func loadUI() {
        ...
        if let annotation = annotation as? Story {
            titleLabel?.text = annotation.storyHashtag
