...
SWIFT_CLASS("_TtC10CBCNews_AR14AnnotationView")
...
@property (nonatomic, readonly, copy) NSString * _Nonnull storyHashtag;
- (nonnull instancetype)initWithStoryHashtag:(NSString * _Nonnull)storyHashtag OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithLocation:(CLLocationCoordinate2D)location title:(NSString * _Nonnull)title OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (void)showInfoViewForStory:(Story * _Nonnull)story;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface ViewController (SWIFT_EXTENSION(CBCNews_AR))
- (void)didTouchWithAnnotationView:(AnnotationView * _Nonnull)annotationView;
@end


@interface ViewController (SWIFT_EXTENSION(CBCNews_AR)) <ARDataSource>
- (ARAnnotationView * _Nonnull)ar:(ARViewController * _Nonnull)arViewController viewForAnnotation:(ARAnnotation * _Nonnull)viewForAnnotation SWIFT_WARN_UNUSED_RESULT;
@end
